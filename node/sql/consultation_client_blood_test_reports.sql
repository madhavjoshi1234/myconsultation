...
CREATE TABLE `client_blood_test_reports` (
  ...
  KEY `client_consultation_id` (`client_consultation_id`),
  CONSTRAINT `client_blood_test_reports_ibfk_1` FOREIGN KEY (`client_consultation_id`) REFERENCES `client_consultations` (`client_consultation_id`) ON DELETE CASCADE
