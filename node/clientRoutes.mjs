    ...
    const verifyClientToken = (req, res, next) => {
        ...
        if (authHeader && authHeader.startsWith('Bearer ')) {
            ...
            jwt.verify(token, JWT_SECRET, (err, decoded) => {
                ...
                // The unified login token has `userId` and `roles`. Older tokens might have `clientId`.
                const id = decoded.userId || decoded.clientId;
                ...
                req.client = {
                    ...decoded,
                    clientId: id // Map userId or clientId to clientId
                };
